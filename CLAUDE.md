...
| `refs/역대기출답안.md` | **모범답안 1차 근거** | 2014–2023 강사(권영주 등)+합격자 기출 모범답안 전체 | ~대용량 |
| `refs/영교론 기출 키워드 정리.md` | 영어교육론 키워드·출처 보완 | 연도별 기출 키워드 + PLLT 등 원전 출처 대조 정리 | ~중량 |
| `refs/윤영어학.md` | **영어학 개념 검증** | "What English Language Teachers Should Know" 윤 영어학 참조서 | ~대용량 |
