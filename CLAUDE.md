...
| 1 | `refs/2025 유희태 답안.md` | 2025 강사 답안 |
| 1 | `refs/2026 강사별 답안.md` | 2026 강사 답안 |
...
| 1 | `refs/2025 유희태 답안.md` | 2025 강사 답안 |
| 1 | `refs/2026 강사별 답안.md` | 2026 강사 답안 |
| 2 | `refs/메가쌤_기출분석.md` | 메가쌤 전공영어 기출 분석 |
...
| 4 | `refs/1. 정T_영교론 챕터별 단권화(한글 설명).md` | 정T 영교론 단권화 |
| 4 | `refs/2. 정T_영교론 챕터별 키텀 맵핑(한글 설명).md` | 정T 키텀 맵핑 |
| 4 | `refs/14. 영교론 헷갈리는 키텀 비교 정리(원서+기본서+글로서리+이티질문) 35p.md` | 헷갈리는 키텀 비교 |
| 4 | `refs/5. 정T_TBP glossary 최종.md` | TBP 글로서리 |
| 4 | `refs/6. 정T_PLLT glossary 최종.md` | PLLT 글로서리 |
...
|------|------|------|
| 1 | `refs/역대기출답안.md` | 2014–2023 강사+합격자 모범답안 전체 |
| 1 | `refs/모범답안_2014-2023.md` | 역대 기출 강사+합격자 모범답안 (txt 변환본) |
| 1 | `refs/루이스기출 5판.md` | 루이스 기출문제 5판 전체 |
| 1 | `refs/2024 유희태 답안.md` / `refs/2024 조셉신 답안.md` | 2024 강사 답안 |
| 1 | `refs/2025 유희태 답안.md` | 2025 강사 답안 |
| 1 | `refs/2026 강사별 답안.md` | 2026 강사 답안 |
| 2 | `refs/밍우_일영문학분석집.md` | 밍우 일반영어·문학 분석집 |
| 2 | `refs/메가쌤_기출분석.md` | 메가쌤 전공영어 기출 분석 |
| 3 | `refs/4. 정T_루이스 기출 Chap.1-10 키텀.md` | 루이스 기출 Ch.1–10 키워드 |
...
1. **강사 답안 최우선**: JSON 작성 시 가장 먼저 해당 연도 강사 답안 MD를 검색하여 `blank_answers` / `essay_content`를 확정한다.
   ...
   - **강사 답안 확인 없이 Claude 독자 판단으로 답안 작성 금지.**
